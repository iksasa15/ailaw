...
/** عبارات دور المحامي — سيناريو حادث مروري (1–10) */
export const LAWYER_PHRASES = {
  1: 'السلام عليكم، أنا محاميك',
  2: 'ماذا حدث بالضبط؟',
  3: 'أين وقع الحادث؟',
  4: 'هل لديك تقرير شرطة؟',
  5: 'من كان يقود السيارة؟',
  6: 'هل أصيب أحد؟',
  7: 'سنطالب بالتعويض',
  8: 'أحضر أوراق التأمين',
  9: 'لا تتحدث مع الطرف الآخر',
  10: 'سأتابع القضية غداً',
}

/** عبارات دور الشخص — موكل في حادث مروري (1–10) */
export const PERSON_PHRASES = {
  1: 'تعرضت لحادث سيارة',
  2: 'اصطدم بي من الخلف',
  3: 'الحادث عند الإشارة',
  4: 'معي تقرير المرور',
  5: 'أنا كنت أقود',
  6: 'أصبت في رقبتي',
  7: 'أريد تعويضاً عادلاً',
  8: 'التأمين رفض الدفع',
  9: 'الطرف الآخر يهددني',
  10: 'أعتمد عليك',
}
